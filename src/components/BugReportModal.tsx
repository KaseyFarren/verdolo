  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-1 text-xs text-cream/70 hover:text-white transition-colors"
      >
        <AlertTriangleIcon size={12} /> Report a problem
      </button>
      <AnimatePresence>
        {open && (
          <motion.div
          ...
          >
            ...
            >
              ...
              <textarea
                autoFocus
                rows={4}
                className="w-full rounded border border-ink/10 bg-white px-3 py-2 text-sm mb-3 focus:outline-none focus:ring-1 focus:ring-accent resize-none"
