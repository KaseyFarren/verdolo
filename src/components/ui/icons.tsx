...
export function UsersIcon({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
      ...
      <path d="M16 8.75A3 3 0 1 1 16.5 14.9" />
      <path d="M20.5 20v-1.2a4 4 0 0 0-2.7-3.78" />
    </svg>
  )
}

export function UsersGroupIcon({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
      <circle cx="12" cy="7" r="3" />
      <path d="M6.5 20v-1.2A5.5 5.5 0 0 1 12 13.3a5.5 5.5 0 0 1 5.5 5.5V20" />
      <circle cx="4.5" cy="10.5" r="2" />
      <path d="M2 19v-.6a3.2 3.2 0 0 1 2.5-3.1" />
      <circle cx="19.5" cy="10.5" r="2" />
      <path d="M22 19v-.6a3.2 3.2 0 0 0-2.5-3.1" />
    </svg>
  )
}
...
export function MessageCircleIcon({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
      <path d="M4 21l1.3-4.2A8 8 0 1 1 12 20a7.9 7.9 0 0 1-3.9-1L4 21z" />
    </svg>
  )
}
...
export function DollarSignIcon({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
      ...
      <path d="M16.5 6.5a3.5 3.5 0 0 0-3.5-1H11a3 3 0 0 0 0 6h2a3 3 0 0 1 0 6h-2.2a3.5 3.5 0 0 1-3.3-2" />
    </svg>
  )
}
...
export function SparkleIcon({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
      <path
        d="M12 2.5c.5 3.6 1.4 5.6 3.2 7.3 1.8 1.8 3.8 2.7 7.3 3.2-3.5.5-5.5 1.4-7.3 3.2-1.8 1.7-2.7 3.7-3.2 7.3-.5-3.6-1.4-5.6-3.2-7.3C7 14.4 5 13.5 1.5 13c3.5-.5 5.5-1.4 7.3-3.2 1.8-1.7 2.7-3.7 3.2-7.3z"
        fill="currentColor"
        stroke="none"
      />
    </svg>
...
export function TrophyIcon({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
      ...
      <path d="M7 5H4a2 2 0 0 0 2 3.5l1.3.4" />
      <path d="M17 5h3a2 2 0 0 1-2 3.5l-1.3.4" />
      <path d="M12 13v3" />
      <path d="M8.5 20.5h7" />
      <path d="M9.5 16.5l-1 4" />
      <path d="M14.5 16.5l1 4" />
    </svg>
  )
}
