...
export default function TermsPage() {
  return (
    <main className="mx-auto max-w-2xl px-4 py-12">
      ...
      <h2 className="mb-2 mt-8 text-base font-semibold text-ink">8. Disclaimers and limitation of liability</h2>
      <p className="mb-6">
      ...
      <p className="mt-10 text-sm text-sage">
        See also our <Link href="/privacy" className="text-accent underline">Privacy Policy</Link>.
      </p>
      </div>
    </main>
  )
