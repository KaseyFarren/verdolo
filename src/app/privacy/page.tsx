...
export default function PrivacyPage() {
  return (
    <main className="mx-auto max-w-2xl px-4 py-12 text-sm leading-relaxed text-gray-700 dark:text-gray-300">
      ...
      <h1 className="mt-4 mb-1 text-2xl font-semibold text-gray-900 dark:text-gray-100">Privacy Policy</h1>
      ...
      <h2 className="mb-2 mt-8 text-base font-semibold text-gray-900 dark:text-gray-100">1. Information we collect</h2>
      ...
      <h2 className="mb-2 mt-8 text-base font-semibold text-gray-900 dark:text-gray-100">2. How we use it</h2>
      <p className="mb-6">
      ...
      <h2 className="mb-2 mt-8 text-base font-semibold text-gray-900 dark:text-gray-100">3. Who we share it with</h2>
      <p className="mb-6">
      ...
      <h2 className="mb-2 mt-8 text-base font-semibold text-gray-900 dark:text-gray-100">4. Data retention and deletion</h2>
      <p className="mb-6">
      ...
      <h2 className="mb-2 mt-8 text-base font-semibold text-gray-900 dark:text-gray-100">5. Security</h2>
      <p className="mb-6">
      ...
      <h2 className="mb-2 mt-8 text-base font-semibold text-gray-900 dark:text-gray-100">6. Your rights</h2>
      <p className="mb-6">
      ...
      <h2 className="mb-2 mt-8 text-base font-semibold text-gray-900 dark:text-gray-100">7. Cookies</h2>
      <p className="mb-6">
        We use essential cookies to keep you signed in and maintain your session. We don&apos;t use third-party
        advertising cookies.
      </p>

      <h2 className="mb-2 mt-8 text-base font-semibold text-gray-900 dark:text-gray-100">8. Children</h2>
      <p className="mb-6">Agency Hub is a business tool and is not directed at, or intended for use by, children.</p>

      <h2 className="mb-2 mt-8 text-base font-semibold text-gray-900 dark:text-gray-100">9. Changes to this policy</h2>
      <p className="mb-6">
        We may update this Policy from time to time. We&apos;ll notify the organization owner of material changes.
      </p>

      <h2 className="mb-2 mt-8 text-base font-semibold text-gray-900 dark:text-gray-100">10. Contact</h2>
      <p className="mb-6">
