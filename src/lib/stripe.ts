...
// Flat, non-tiered price for seats bought beyond the 4 (owner + 3) a lifetime purchase already
// includes - the lifetime one-time fee already covers those 4, so this price never re-bills them.
